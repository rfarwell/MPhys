"""
This code is essentially a copy of Cropper_GTV-1.py which was adapted from Patrick's
original cropping code at: https://github.com/PHastings37/Mphys-proj/blob/main/image%20cropper.py
...
This code will work for the 'ALL_GTV' masks that were made when the resampling code was run.
"""
...
output_path = "/Volumes/Extreme_SSD/MPhys/TCIA_Data/NSCLC-Radiomics/NSCLC_resampled_cropped_ALL_GTV"
#==========================================================================
